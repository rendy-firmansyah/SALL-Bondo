...
export default function Feedback() {
    ...
    //         const learningArray = Object.entries(learningObj).map(([label, value]) => ({
    //             label,
    //             value: Number(value),
    //         }));

    //         const usabilityArray = Object.entries(usabilityObj).map(([label, value]) => ({
    //             label,
    //             value: Number(value),
    //         }));
