                                ...
                                <div className="col-span-12 flex items-center py-15 md:col-span-7 md:py-0">
                                    <div className="text-center md:text-start">
                                        ...
                                        <p className="font-sans text-base md:text-lg">
                                            SALL-BONDO is a self-access English learning platform developed through the 2025 DPPM Kemendikbudristek
                                            grant titled “Penguatan Kapasitas Bahasa Inggris dan Literasi Budaya melalui Penciptaan Motif Batik
                                            Kontemporer Berbasis Kearifan Lokal Tapal Kuda.”, in collaboration with Forum Pemuda Pelopor Situbondo. It
                                            aims to enhance English proficiency and cultural literacy through flexible online and offline learning,
                                            including the creation of contemporary batik motifs inspired by local wisdom. Managed by Ika Fitriani and
                                            Chandra Ayu Proborini (Universitas Jember), and Diana Setia Dewi (ITB Tuban), the program empowers
                                            Situbondo's youth by integrating language, culture, and creativity.
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="my-10 flex justify-center md:my-20">
                            ...
                            <div className="flex flex-col gap-y-4 md:hidden">
                                ...
                                <div className="flex h-[240px] w-[370px] flex-col justify-center gap-y-2 rounded-2xl border-2 border-gray-300 bg-white px-8">
                                    ...
                                    <div className="flex justify-center text-center">
                                        <h2 className="font-sans text-lg">
                                            Take time to reflect on your learning by reviewing what you've understood, noting any challenges, and
                                            thinking about how you can use the new knowledge in real life.
                                        </h2>
                                    </div>
                                </div>
                            </div>
